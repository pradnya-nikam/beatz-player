...
public abstract class BaseOutputAudioDevice extends AudioDeviceBase {
    ...
    protected void writeImpl(short[] samples, int offs, int len) throws JavaLayerException {
        if(!init)
        {
            System.out.println("number of channels: " + getDecoder().getOutputChannels());
            System.out.println("number of samples: " + getDecoder().getOutputFrequency());
...
//            log.log(Level.INFO, "buffer length: " + len);
            System.out.println("samples/ms: " + samplesPerMillisecond);
...
//        log.log(Level.FINE, "position: " + position + "ms");
        System.out.println("position: " + position + "ms");
        return position;
    }
